...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    status: "Concluído",
    description: [
      "A Sala Jardim de Luz nasceu da ideia de transformar uma sala comum em um espaço de pausa dentro da rotina urbana. O projeto foi pensado para um casal que valoriza conforto, estética limpa e uma atmosfera de hotel boutique, sem perder a sensação de lar.",
